...
class widgetSD(QWidget):
    ...
    def analyze(self):
        ...
        self.plot.setup()
        self.plot.addLegend()
        self.plot.plot(T_dapp, Dapp, name='Dapp')
        self.plot.plot(T[0:n_points_t], m1[0:n_points_t], pen=(1, 3), name = 'Brownian')
        self.plot.plot(T[0:n_points_t], m2[0:n_points_t], pen=(2, 3), name = 'Confined')
        self.plot.plot(T[0:n_points_t], m3[0:n_points_t], pen=(3, 3), name = 'Hopping')
